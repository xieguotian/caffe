    ...
    if layer.type == 'Convolution' or layer.type == 'Deconvolution':
        ...
        node_label = '"%s%s(%s)%skernel size: %d%sstride: %d%spad: %d"' %\
                     (layer.name,
                      ...
                      if len(layer.convolution_param.kernel_size._values) else 1,
                      separator,
                      layer.convolution_param.stride[0]
                      if len(layer.convolution_param.stride._values) else 1,
                      separator,
                      layer.convolution_param.pad[0]
                      if len(layer.convolution_param.pad._values) else 0)
