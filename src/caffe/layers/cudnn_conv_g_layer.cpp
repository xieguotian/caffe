...
void CuDNNConvolutionGLayer<Dtype>::LayerSetUp(
...
template <typename Dtype>
void CuDNNConvolutionGLayer<Dtype>::Reshape(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
  ...
  for (int i = 0; i < bottom.size(); i++) {
    ...
    cudnn::setConvolutionDesc<Dtype>(&conv_descs_[i], bottom_descs_[i],
        ...
        stride_h, stride_w);
	cudnn::setConvolutionDesc<Dtype>(&conv_descs_[i], this->group_);
...
template <typename Dtype>
CuDNNConvolutionGLayer<Dtype>::~CuDNNConvolutionGLayer() {
...
INSTANTIATE_CLASS(CuDNNConvolutionGLayer);
