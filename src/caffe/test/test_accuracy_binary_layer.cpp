...
class AccuracyBinaryLayerTest : public CPUDeviceTest<Dtype> {
 protected:
	 AccuracyBinaryLayerTest()
  ...
  virtual ~AccuracyBinaryLayerTest() {
...
TYPED_TEST_CASE(AccuracyBinaryLayerTest, TestDtypes);

TYPED_TEST(AccuracyBinaryLayerTest, TestSetup) {
...
TYPED_TEST(AccuracyBinaryLayerTest, TestSetupTopK) {
  LayerParameter layer_param;
...
TYPED_TEST(AccuracyBinaryLayerTest, TestSetupOutputPerClass) {
  LayerParameter layer_param;
  AccuracyBinaryLayer<TypeParam> layer(layer_param);
...
TYPED_TEST(AccuracyBinaryLayerTest, TestForwardCPU) {
  LayerParameter layer_param;
  AccuracyBinaryLayer<TypeParam> layer(layer_param);
  layer.SetUp(this->blob_bottom_vec_, this->blob_top_vec_);
...
//TYPED_TEST(AccuracyBinaryLayerTest, TestForwardWithSpatialAxes) {
...
TYPED_TEST(AccuracyBinaryLayerTest, TestForwardIgnoreLabel) {
  LayerParameter layer_param;
...
TYPED_TEST(AccuracyBinaryLayerTest, TestForwardCPUTopK) {
  LayerParameter layer_param;
