...
class EntropyCrossWithLossLayer : public LossLayer<Dtype> {
 public:
   /**
    ...
    */
	 explicit EntropyCrossWithLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "EntropyCrossWithLoss"; }
