#ifndef CAFFE_BATCHNORMTORCH_LAYER_HPP_
#define CAFFE_BATCHNORMTORCH_LAYER_HPP_
...
class BatchNormTorchLayer : public Layer<Dtype> {
 public:
	 explicit BatchNormTorchLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "BatchNormTorch"; }
