...
class EntropyTotalWithLossLayer : public LossLayer<Dtype> {
 public:
   /**
    ...
    */
	 explicit EntropyTotalWithLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "EntropyTotalWithLoss"; }
 ...
 protected:
  ...
  Blob<Dtype> prob_history_;
  bool is_prob_history_init_;
  Dtype momemtum_;
  Blob<Dtype> num_mul_;
  Blob<Dtype> channel_mul_;
  Dtype norm_factor_;
  Blob<Dtype> cache_;
  Blob<Dtype> inner_mul_;
  bool use_T_;
  float temperature_;
};
