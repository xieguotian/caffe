...
class BatchNormOptLayer : public Layer<Dtype> {
 public:
	 explicit BatchNormOptLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "BatchNormOpt"; }
