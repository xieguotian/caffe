#ifndef CAFFE_FEATURE_NORM_LOSS_LAYER_HPP_
#define CAFFE_FEATURE_NORM_LOSS_LAYER_HPP_
...
class FeatureNormLossLayer : public LossLayer<Dtype> {
 public:
	 explicit FeatureNormLossLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param) {}
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline const char* type() const { return "FeatureNormLoss"; }
  /**
